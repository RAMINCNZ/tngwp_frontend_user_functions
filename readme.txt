...
This plugin is specifically designed for Wordpress/TNG integrations. It provides shortcodes for two levels of user registration, a front-end profile page, a one-line login/logout shortcode, and a login/logout widget.
